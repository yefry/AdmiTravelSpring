...
public class TourBLImpTest {
	...
	public void testGuardar() {
		try {
			tourBL.guardar("Car003", "Museo de oro", "");
			System.out.println("Tour guardado");
			assertTrue(true);
	...
	public void testActualizar() {
		Tour tour = new Tour();
		try {
			tourBL.actualizar(tour, "Car003", "Museo de oro", "Tour actualizado");
			assertTrue(true);
		} catch (Exception e) {
			fail(e.getMessage());
			e.printStackTrace();
	...
	public void testObtener() {
		try {
			Tour tour = tourBL.obtener("SaM001");
